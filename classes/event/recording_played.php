...
/**
 * The mod_meet recording played event
 *
 * @package   mod_meet
 ...
 * @author    Christian Bayer  (christian.bayer@universo.univates.br)
 */
class recording_played extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' played the recording with id '$this->objectid' for the 'meet' " .
            "activity with course module id '$this->contextinstanceid'.";
    }

    protected function get_legacy_logdata() {
        return array($this->courseid, 'meet', 'view recording', 'view.php?id=' . $this->contextinstanceid .
            '&recordingid=' . $this->objectid, $this->objectid, $this->contextinstanceid);
    }

    public static function get_name() {
        return get_string('event_recording_played', 'meet');
    }
