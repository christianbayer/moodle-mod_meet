...
/**
 * The mod_meet recording updated event
 *
 * @package   mod_meet
 ...
 * @author    Christian Bayer  (christian.bayer@universo.univates.br)
 */
class recording_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the recording with id '$this->objectid' for the 'meet' " .
    ...
    public static function get_name() {
        return get_string('event_recording_updated', 'meet');
    }
